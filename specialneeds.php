...
<head>
  ...
  <title>Kindergartens|Tunza Bora</title>
...
<body>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Kindergarten</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
          ...
          <li class="dropdown"><a href="#" class="active"><span>Children with Special Needs</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
  ...
  <main id="main">
    ...
    <div class="breadcrumbs" data-aos="fade-in">
      <div class="container">
        <h2>Find a Special Needs Centre</h2>
      </div>
    </div><!-- End Breadcrumbs -->
      ...
      <div class="container" data-aos="fade-up">
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
            <img src="assets/img/course-details.jpg" class="img-fluid" alt="" width="100%">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <h2>Find the best <strong><?php print ucfirst($special)?> </strong>special needs centres in your area</h2>
            <p class="fst-italic">Enter your county, sub-county or location to find special needs centres in your area.</p>
            <form action="search.php" method="get" role="form" class="">
              ...
              <div class="col-md-6 form-group mt-3 mt-md-0">
              <div class=""><br><button type="submit" class="get-started-btn" name="find_special">Find <?php print ucfirst($special)?> Special Needs Centre</button></div>
              </div>
              </div>
            </form>
          </div>
    ...
    if($rowcount>0)
    {
      ...
      <div class="container" data-aos="fade-up">
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <h3>Featured special needs centres in the country</h3>
