    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li class="dropdown"><a href="#" class="active"><span>Kindergarten</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <h2>Find the best <strong><?php print ucfirst($kindergarten)?> </strong>kindergarten in your area</h2>
            <p class="fst-italic">Enter your county, sub-county or location to find kindergartens in your area.</p>
            <form action="search.php" method="get" role="form" class="">
              ...
              <div class="col-md-6 form-group mt-3 mt-md-0">
              <div class=""><br><button type="submit" class="get-started-btn" name="find_kindergarten">Find <?php print ucfirst($kindergarten)?> Kindergarten</button></div>
              </div>
              </div>
            </form>
          </div>
    ...
    if($rowcount>0)
    {
      ...
      <div class="container" data-aos="fade-up">
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <h3>Featured kindergartens around the country</h3>
