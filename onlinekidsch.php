...
<head>
  ...
  <title>Online Kids Schools|Tunza Bora</title>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a href="onlinekidsch.php?search" class="active">Online Kids Schools</a></li>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <h2>Find the best <strong>Online Kids Schools </strong>daycare across the country</h2>
            <p class="fst-italic">Enter the age of your child to find the best online kids schools.</p>
            <form action="search.php" method="get" role="form" class="">
              ...
              <div class="col-md-6 form-group mt-3 mt-md-0">
              <div class=""><br><button type="submit" class="get-started-btn" name="find_onlinekidsch">Find Online Kids School</button></div>
              </div>
              </div>
            </form>
          </div>
    ...
    if($rowcount>0)
    {
      ...
      <div class="container" data-aos="fade-up">
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <h3>Featured Online Schools for Kids around the country</h3>
